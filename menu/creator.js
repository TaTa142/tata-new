...
├── _Example: ${prefix}quotemaker Teks/Fajri/random_
┠≽ *${prefix}nulis text*
├── _Example: ${prefix}nulis Fajri Gans_
┠≽ *${prefix}croman TEXT dan Friend*
├── _Example: ${prefix}croman Fajri & Friend_
┠≽ *${prefix}slide TEXT*
├── _Example: ${prefix}slide Fajri & Friend_
┠≽ *${prefix}trigger*
...
┠≽ *${prefix}ephoto 1 - 216*
├── _Example: ${prefix}ephoto 5 Fajri_
┠≽ *${prefix}listtextpro*
├── _Example: untuk menampilkan list text pro_
┠≽ *${prefix}textpro 1 - 162*
├── _Example: ${prefix}textpro 1 Fajri_
┠≽ *${prefix}fbgoldbutton TEXT*
├── _Example: ${prefix}fbgoldbutton Fajri_
┠≽ *${prefix}tahta TEXT*
├── _Example: ${prefix}tahta Fajri_
┠≽ *${prefix}cglitch TEXT/TEXT*
├── _Example: ${prefix}cglitch Fajri/Gans_
┠≽ *${prefix}cglass TEXT*
├── _Example: ${prefix}cglass Fajri_
┠≽ *${prefix}cballon TEXT*
├── _Example: ${prefix}cballon Fajri_
┠≽ *${prefix}cstyle TEXT*
├── _Example: ${prefix}cstyle Fajri_
┠≽ *${prefix}clove TEXT*
├── _Example: ${prefix}clove Fajri_
┠≽ *${prefix}cparty TEXT*
├── _Example: ${prefix}cparty Fajri_
┠≽ *${prefix}csky TEXT*
├── _Example: ${prefix}csky Fajri_
┠≽ *${prefix}tts id TEXT*
├── _Example: ${prefix}tts id Fajri_
┠≽ *${prefix}ttp TEXT*
├── _Example: ${prefix}ttp Fajri_
├───────────────────
┠≽ *${prefix}stiker*
